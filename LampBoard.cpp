...
CLampBoard::CLampBoard()
{
	...
	ACE_OS::memset(iLampBoardTemp , 0 , 4);// ADD: 2013 0712 14 59
	ACE_OS::memset(m_ucLampStas , 0 , 48); // ADD: 2013 0712 10 59
	ACE_OS::memset(m_ucCheckCfg , 0 , 4); // ADD: 2013 0712 11 11
	ACE_OS::memset(m_usLampElect , 0 , 32); // ADD: 2013 0712 14 11
	ACE_OS::memset(m_ucLampOnCfg , 0 , 12); // ADD: 2013 0712 11 40
	ACE_OS::memset(m_ucLampConflic , 0 , 16); // ADD: 2013 0802 11 20
