...
const int MAX_PHASE              = 16;   //最大相位表数
const int MAX_OVERLAP_PHASE      = 8;    //最大跟随相位表数
const int MAX_CONFLICT_PHASE     = 16;   //最大冲突表数
const int MAX_STATUSOUT_PER      = 8;    //每组状态输出包含的个数
const int MAX_STEP               = 64;   //最大的步伐数
const int MAX_LAMP_BOARD         = 4;    //最大灯驱板数
...
const int MAX_DREC               = 32;  //最大方向数量   201310181705
